...
import (
	...
	versioned "kubernetes-client-project/demo07/k8s_customize_controller/pkg/client/clientset/versioned"
	internalinterfaces "kubernetes-client-project/demo07/k8s_customize_controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "kubernetes-client-project/demo07/k8s_customize_controller/pkg/client/listers/readailib/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ReadailibV1().Students(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReadailibV1().Students(namespace).Watch(options)
			},
		},
		&readailibv1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&readailibv1.Student{}, f.defaultInformer)
}
