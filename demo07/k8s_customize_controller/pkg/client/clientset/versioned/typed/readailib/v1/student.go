...
import (
	...
	scheme "kubernetes-client-project/demo07/k8s_customize_controller/pkg/client/clientset/versioned/scheme"
	"time"
...
func newStudents(c *ReadailibV1Client, namespace string) *students {
	return &students{
		client: c.RESTClient(),
		ns:     namespace,
	}
