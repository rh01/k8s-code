...
import (
	...
	informers "kubernetes-client-project/demo07/k8s_customize_controller/pkg/client/informers/externalversions"
	"kubernetes-client-project/demo07/k8s_customize_controller/pkg/signals"
)
...
func main() {
	...
	controller := NewController(kubeClient, studentClient,
		studentInformerFactory.Readailib().V1().Students())
...
func init() {
	if home := homedir.HomeDir(); home != "" {
		...
		flag.StringVar(&kubeconfig, "kubeconfig", path.Join(""), "Path to a kubeconfig. Only required if out-of-cluster.")
	}
